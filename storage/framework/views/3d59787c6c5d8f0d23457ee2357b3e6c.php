    ...
    <aside
        ...
        <div class="p-5 border-b border-white/10 relative overflow-hidden group shrink-0">
            ...
            <div class="relative flex items-center gap-3">
                <div class="w-16 h-16 rounded-xl overflow-hidden flex items-center justify-center">
                    <img src="<?php echo e(asset('images/logo-cropped.png')); ?>" alt="Digitron" class="w-full h-full object-contain p-1">
                </div>
                <div>
        ...
        <div class="p-4 border-b border-white/10 shrink-0 bg-white/[0.02]">
            <div class="flex items-center gap-3 p-3 rounded-xl bg-white/5 border border-white/5">
                ...
                <div class="flex-1 min-w-0">
                    <div class="text-sm font-medium truncate"><?php echo e(auth()->user()->email); ?></div>
                </div>
            </div>
        </div>
        ...
        <nav class="flex-1 p-4 space-y-1 overflow-y-auto overflow-x-hidden custom-scrollbar" data-scroll-lock>
            ...
            <a href="<?php echo e(route('admin.dashboard')); ?>"
                class="sidebar-link <?php echo e(request()->routeIs('admin.dashboard') ? 'active text-white bg-white/10' : 'text-gray-400 hover:text-white hover:bg-white/5'); ?> flex items-center gap-3 px-4 py-3 rounded-xl transition-all group"
            ...
            <a href="<?php echo e(route('admin.categories.index')); ?>"
                class="sidebar-link <?php echo e(request()->routeIs('admin.categories.*') ? 'active' : ''); ?> flex items-center gap-3 px-4 py-3 rounded-xl text-gray-400 hover:text-white hover:bg-white/5 transition-all group"
                @click="if (window.innerWidth < 1024) sidebarOpen = false">
                ...
                <span class="ml-auto text-xs bg-white/10 px-2 py-0.5 rounded-full"><?php echo e($sidebarCounts['categories'] ?? 0); ?></span>
            </a>

            <a href="<?php echo e(route('admin.products.index')); ?>"
                class="sidebar-link <?php echo e(request()->routeIs('admin.products.*') ? 'active text-white bg-white/10' : 'text-gray-400 hover:text-white hover:bg-white/5'); ?> flex items-center gap-3 px-4 py-3 rounded-xl transition-all group"
                @click="if (window.innerWidth < 1024) sidebarOpen = false">
                ...
                <span>Products</span>
                <span class="ml-auto text-xs bg-white/10 px-2 py-0.5 rounded-full"><?php echo e($sidebarCounts['products'] ?? 0); ?></span>
            </a>
            ...
            <a href="<?php echo e(route('admin.newsletter.index')); ?>"
                ...
                <span class="ml-auto text-xs bg-admin-primary/20 text-admin-primary px-2 py-0.5 rounded-full"><?php echo e($sidebarCounts['newsletter'] ?? 0); ?></span>
            </a>
            ...
            <a href="<?php echo e(route('admin.quotes.index')); ?>"
                ...
                <span>Quotes</span>
                <span class="ml-auto text-xs bg-admin-danger/20 text-admin-danger px-2 py-0.5 rounded-full"><?php echo e(($sidebarCounts['quotes'] ?? 0)); ?></span>
            </a>

            <a href="<?php echo e(route('admin.orders.index')); ?>"
                class="sidebar-link <?php echo e(request()->routeIs('admin.orders.*') ? 'active' : ''); ?> flex items-center gap-3 px-4 py-3 rounded-xl text-gray-400 hover:text-white hover:bg-white/5 transition-all group"
                @click="if (window.innerWidth < 1024) sidebarOpen = false">
                <div class="w-8 h-8 rounded-lg bg-white/5 flex items-center justify-center group-hover:bg-admin-primary/20 group-hover:text-admin-primary transition-colors">
                    <i class="bi bi-bag-check-fill"></i>
                </div>
                <span>Orders</span>
                <span class="ml-auto text-xs bg-admin-primary/20 text-admin-primary px-2 py-0.5 rounded-full"><?php echo e($sidebarCounts['orders'] ?? 0); ?></span>
            </a>

            <a href="<?php echo e(route('admin.home-showcase.index')); ?>"
                class="sidebar-link <?php echo e(request()->routeIs('admin.home-showcase.*') ? 'active' : ''); ?> flex items-center gap-3 px-4 py-3 rounded-xl text-gray-400 hover:text-white hover:bg-white/5 transition-all group"
                @click="if (window.innerWidth < 1024) sidebarOpen = false">
                <div class="w-8 h-8 rounded-lg bg-white/5 flex items-center justify-center group-hover:bg-admin-primary/20 group-hover:text-admin-primary transition-colors">
                    <i class="bi bi-images"></i>
                </div>
                <span>Home Showcase</span>
                <span class="ml-auto text-xs bg-admin-primary/20 text-admin-primary px-2 py-0.5 rounded-full"><?php echo e($sidebarCounts['home_showcase'] ?? 0); ?></span>
            </a>

            <a href="<?php echo e(route('admin.chatbot-leads.index')); ?>"
                class="sidebar-link <?php echo e(request()->routeIs('admin.chatbot-leads.*') ? 'active text-white bg-white/10' : 'text-gray-400 hover:text-white hover:bg-white/5'); ?> flex items-center gap-3 px-4 py-3 rounded-xl transition-all group"
                @click="if (window.innerWidth < 1024) sidebarOpen = false">
                <div class="w-8 h-8 rounded-lg bg-white/5 flex items-center justify-center group-hover:bg-admin-primary/20 group-hover:text-admin-primary transition-colors">
                ...
                <span class="ml-auto text-xs bg-admin-warning/20 text-admin-warning px-2 py-0.5 rounded-full">
                    <?php echo e($sidebarCounts['chatbot_leads'] ?? 0); ?>
            ...
            <a href="<?php echo e(route('admin.settings')); ?>"
                class="sidebar-link <?php echo e(request()->routeIs('admin.settings') ? 'active text-white bg-white/10' : 'text-gray-400 hover:text-white hover:bg-white/5'); ?> flex items-center gap-3 px-4 py-3 rounded-xl transition-all group"
                @click="if (window.innerWidth < 1024) sidebarOpen = false">
...
</div><?php /**PATH C:\DigitronComputers\digitron-store\resources\views/admin/partials/sidebar.blade.php ENDPATH**/ ?>
...
<?php $__env->startSection('title', 'Chatbot Leads | Digitron Command Center'); ?>
    ...
    <div class="relative z-10">
            ...
            <div class="flex items-center justify-between gap-4">
                ...
                <div class="flex items-center gap-2 shrink-0">
                    <div class="hidden sm:flex items-center gap-2 px-4 py-2 rounded-xl border border-white/10 bg-white/5">
                        ...
                        <span class="text-sm text-gray-300">New: <?php echo e($newCount ?? 0); ?></span>
                    </div>

                    <div class="hidden sm:flex items-center gap-2 px-4 py-2 rounded-xl border border-white/10 bg-white/5">
                        <span class="w-2.5 h-2.5 rounded-full bg-admin-success"></span>
                        <span class="text-sm text-gray-300">Total: <?php echo e($totalCount ?? ($leads->total() ?? 0)); ?></span>
                    </div>
                </div>
            </div>
        </header>
        ...
        <div class="p-4 lg:p-8 space-y-6">
            ...
            <div class="glass-panel rounded-2xl border border-white/10 p-4 lg:p-6">
                <form method="GET" action="<?php echo e(route('admin.chatbot-leads.index')); ?>" class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-5 gap-4">
                    <div>
                    ...
                    <div>
                        ...
                        <select
                            ...
                            <?php $__currentLoopData = ['new', 'reviewed', 'contacted', 'converted', 'closed']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $status): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div>
                        ...
                        <select
                            ...
                            <?php $__currentLoopData = ['default_message', 'quick_button', 'custom_message']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $source): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($source); ?>" <?php echo e(request('source_type') === $source ? 'selected' : ''); ?>>
                                <?php echo e(ucfirst(str_replace('_', ' ', $source))); ?>
                    ...
                    <div class="md:col-span-2 xl:col-span-5 flex flex-wrap gap-3 pt-1">
                        ...
                        <a
                            href="<?php echo e(route('admin.chatbot-leads.index')); ?>"
            ...
            <div class="glass-panel rounded-2xl border border-white/10 overflow-hidden">
                    ...
                    <table class="w-full min-w-[1200px] text-sm">
                        ...
                        <tbody>
                            ...
                            <tr
                                ...
                                onclick="toggleLeadDetail('<?php echo e($detailRowId); ?>', 'arrow-<?php echo e($lead->id); ?>')">
                                <td class="px-4 lg:px-6 py-4 text-white font-semibold">
                                    <?php echo e($leads->firstItem() + $index); ?>

                                </td>

                                <td class="px-4 lg:px-6 py-4 text-gray-300 whitespace-nowrap">
                                    <div><?php echo e(optional($lead->created_at)->format('d M Y')); ?></div>
                                    <div class="text-xs text-gray-500"><?php echo e(optional($lead->created_at)->format('h:i A')); ?></div>
                                </td>

                                <td class="px-4 lg:px-6 py-4">
                                    <div class="text-white font-medium max-w-[220px] truncate">
                                        <?php echo e($lead->product_name ?: 'General Inquiry'); ?>

                                    </div>
                                </td>

                                <td class="px-4 lg:px-6 py-4 text-gray-300">
                                    <?php echo e($lead->product_sku ?: '—'); ?>

                                </td>

                                <td class="px-4 lg:px-6 py-4">
                                    <div class="max-w-[220px] text-gray-300 truncate">
                                        <?php echo e($shortMessage); ?>
                                ...
                                <td class="px-4 lg:px-6 py-4 text-gray-300">
                                    <?php echo e($lead->button_label ?: '—'); ?>

                                </td>

                                <td class="px-4 lg:px-6 py-4">
                                    <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-semibold bg-<?php echo e($statusColor); ?>/20 text-<?php echo e($statusColor); ?>">
                                ...
                                <td class="px-4 lg:px-6 py-4 text-gray-400">
                                    <div class="max-w-[150px] truncate"><?php echo e($lead->ip_address ?: '—'); ?></div>
                                </td>
                                ...
                                <td class="px-4 lg:px-6 py-4 text-gray-400">
                                    <div class="flex items-center gap-2 text-gray-400">
                                        ...
                                        <i class="bi bi-chevron-down text-xs transition-transform duration-300"
                                            id="arrow-<?php echo e($lead->id); ?>"></i>
                                    </div>
                                </td>
                            </tr>

                            <tr id="<?php echo e($detailRowId); ?>"
                                    ...
                                    <div class="grid grid-cols-1 xl:grid-cols-3 gap-4">
                                            ...
                                            <div class="rounded-2xl border border-white/10 bg-white/[0.03] p-4">
                                                ...
                                                <div class="grid grid-cols-1 md:grid-cols-2 gap-3 text-sm">
                                                    <div>
                                                        ...
                                                        <span class="text-white"><?php echo e($lead->product_name ?: 'General Inquiry'); ?></span>
                                                    </div>
                                                    <div>
                                                        <span class="text-gray-500">SKU:</span>
                                                        <span class="text-white"><?php echo e($lead->product_sku ?: '—'); ?></span>
                                                    </div>
                                                    <div>
                                                        <span class="text-gray-500">Source:</span>
                                                        <span class="text-white"><?php echo e($sourceLabel); ?></span>
                                                    </div>
                                                    <div>
                                                        <span class="text-gray-500">Button:</span>
                                                        <span class="text-white"><?php echo e($lead->button_label ?: '—'); ?></span>
                                                    </div>
                                                    <div>
                                                        <span class="text-gray-500">IP Address:</span>
                                                        <span class="text-white"><?php echo e($lead->ip_address ?: '—'); ?></span>
                                                    </div>
                                                    <div>
                                                        <span class="text-gray-500">Created:</span>
                                                        <span class="text-white"><?php echo e(optional($lead->created_at)->format('d M Y, h:i A')); ?></span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="space-y-4">
                                            <div class="rounded-2xl border border-white/10 bg-white/[0.03] p-4">
                                                ...
                                                <form method="POST" action="<?php echo e(route('admin.chatbot-leads.update-status', $lead)); ?>" class="space-y-3">
                                                    <?php echo csrf_field(); ?>
                ...
                <?php if(method_exists($leads, 'links')): ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\DigitronComputers\digitron-store\resources\views/admin/chatbot_leads/index.blade.php ENDPATH**/ ?>
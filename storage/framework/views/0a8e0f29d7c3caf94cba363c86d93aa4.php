        ...
        <div class="border-b border-white/5">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                <div class="flex flex-col lg:flex-row items-center justify-between gap-8">
                    ...
                    <form id="newsletterForm" action="<?php echo e(route('newsletter.subscribe')); ?>" method="POST" class="w-full max-w-md">
                        <?php echo csrf_field(); ?>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 lg:gap-8">
                ...
                <div class="lg:col-span-4 space-y-6">
                    <div class="flex items-center gap-3 group">
                        <div class="relative">
                            <img src="<?php echo e(asset('images/logo-cropped.png')); ?>" alt="Digitron Computers UAE" class="h-14 w-auto object-contain relative z-10">
                ...
                <div class="lg:col-span-2">
                    ...
                    <ul class="space-y-3">
                        <li>
                            <a href="<?php echo e(route('shop')); ?>" class="group flex items-center gap-2 text-gray-400 hover:text-white transition-colors text-sm">
                        ...
                        <li>
                            <a href="<?php echo e(route('shop', ['category' => 'graphics-cards'])); ?>" class="group flex items-center gap-2 text-gray-400 hover:text-white transition-colors text-sm">
                                <span class="w-0 group-hover:w-2 h-px bg-brand-accent transition-all"></span>
                        ...
                        <li>
                            <a href="<?php echo e(route('shop', ['category' => 'processors'])); ?>" class="group flex items-center gap-2 text-gray-400 hover:text-white transition-colors text-sm">
                                <span class="w-0 group-hover:w-2 h-px bg-brand-accent transition-all"></span>
                        ...
                        <li>
                            <a href="<?php echo e(route('shop', ['category' => 'memory'])); ?>" class="group flex items-center gap-2 text-gray-400 hover:text-white transition-colors text-sm">
                                <span class="w-0 group-hover:w-2 h-px bg-brand-accent transition-all"></span>
                        ...
                        <li>
                            <a href="<?php echo e(route('shop', ['category' => 'storage'])); ?>" class="group flex items-center gap-2 text-gray-400 hover:text-white transition-colors text-sm">
                                <span class="w-0 group-hover:w-2 h-px bg-brand-accent transition-all"></span>
                        ...
                        <li>
                            <a href="<?php echo e(route('shop', ['category' => 'motherboards'])); ?>" class="group flex items-center gap-2 text-gray-400 hover:text-white transition-colors text-sm">
                                <span class="w-0 group-hover:w-2 h-px bg-brand-accent transition-all"></span>
                        ...
                        <li>
                            <a href="<?php echo e(route('shop', ['category' => 'power-supply'])); ?>" class="group flex items-center gap-2 text-gray-400 hover:text-white transition-colors text-sm">
                                <span class="w-0 group-hover:w-2 h-px bg-brand-accent transition-all"></span>
                ...
                <div class="lg:col-span-2">
                    ...
                    <ul class="space-y-3">
                        <li>
                            <a href="<?php echo e(route('quote')); ?>" class="group flex items-center gap-2 text-gray-400 hover:text-white transition-colors text-sm">
                        ...
                        <li>
                            <a href="<?php echo e(route('quote')); ?>#quote-section" class="group flex items-center gap-2 text-gray-400 hover:text-white transition-colors text-sm">
                                <span class="w-0 group-hover:w-2 h-px bg-brand-secondary transition-all"></span>
                ...
                <div class="lg:col-span-2">
                    ...
                    <ul class="space-y-3">
                        <li>
                            <a href="<?php echo e(route('about')); ?>" class="group flex items-center gap-2 text-gray-400 hover:text-white transition-colors text-sm">
                        ...
                        <li>
                            <a href="<?php echo e(route('home')); ?>" class="group flex items-center gap-2 text-gray-400 hover:text-white transition-colors text-sm">
                                <span class="w-0 group-hover:w-2 h-px bg-emerald-400 transition-all"></span>
                ...
                <div class="lg:col-span-2">
                    ...
                    <div class="flex flex-wrap gap-3 mb-8">
                        ...
                        <a href="#" class="w-10 h-10 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center text-gray-400 <?php echo e($social['color']); ?> <?php echo e($social['bg']); ?> hover:border-current transition-all group">
                            <i class="bi bi-<?php echo e($social['icon']); ?> text-lg group-hover:scale-110 transition-transform"></i>
                        </a>
                    ...
                    <div class="flex flex-wrap gap-2">
                        <?php $__currentLoopData = ['credit-card', 'paypal', 'apple', 'google']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $payment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="px-3 py-1.5 rounded-lg bg-white/5 border border-white/10 text-gray-400 text-xs flex items-center gap-1.5">
                            <i class="bi bi-<?php echo e($payment); ?>"></i>
                            <span class="capitalize"><?php echo e($payment === 'credit-card' ? 'Card' : $payment); ?></span>
                        </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
                </div>
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
                <div class="flex flex-col md:flex-row items-center justify-between gap-4">
                    <div class="flex flex-wrap items-center justify-center gap-6 text-xs text-gray-500">
                        <span>&copy; <?php echo e(date('Y')); ?> Digitron Computers UAE. All rights reserved.</span>
...
</footer><?php /**PATH C:\DigitronComputers\digitron-store\resources\views/partials/footer.blade.php ENDPATH**/ ?>
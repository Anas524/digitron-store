...
<section class="py-12 -mt-6 md:-mt-8 relative z-30">
    ...
    <div class="mt-16 pt-16 border-t border-white/10">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <a href="<?php echo e(route('product.show', $rec->slug)); ?>" class="group rounded-xl border border-white/5 bg-white/[0.02] p-4 hover:border-brand-accent/30 transition-all hover:-translate-y-1">

...
<?php $__env->startSection('title', 'Contact Us | Get a Quote | Digitron Computers UAE'); ?>
...
<section class="relative h-[70vh] min-h-[600px] overflow-hidden flex items-center justify-center pt-28 pb-28">
  ...
  <div class="absolute inset-0 w-full h-full z-0">
    <video autoplay muted loop playsinline class="object-cover w-full h-full opacity-60 scale-110" id="hero-video">
      <source src="<?php echo e(asset('videos/video-ref-2.mp4')); ?>" type="video/mp4">
    </video>
  ...
  <div class="absolute inset-0 overflow-hidden pointer-events-none">
    <?php for($i = 0; $i < 25; $i++): ?>
      ...
      style="<?php echo \Illuminate\Support\Arr::toCssStyles([ 'left'=> rand(0,100).'%',
      'top' => rand(0,100).'%',
...
<section id="contact-methods" class="relative z-20 -mt-10 md:-mt-14 pt-12 pb-20 scroll-mt-28">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
      ...
      <a href="<?php echo e($method['link']); ?>"
        class="group glass-panel rounded-2xl p-6 border border-white/10 transition-all duration-500 hover:-translate-y-3 hover:shadow-xl <?php echo e($method['hoverBorder']); ?> <?php echo e($method['shadow']); ?> relative overflow-hidden">
        <!-- Hover Glow -->
        <div class="absolute inset-0 bg-gradient-to-br <?php echo e($method['glowBg']); ?> to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>

        <div class="relative">
          <div class="w-14 h-14 rounded-2xl <?php echo e($method['iconBg']); ?> flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300">
            <i class="bi bi-<?php echo e($method['icon']); ?> text-2xl <?php echo e($method['iconText']); ?>"></i>
          </div>

          <h3 class="text-lg font-bold text-white mb-1"><?php echo e($method['title']); ?></h3>
          <div class="<?php echo e($method['valueText']); ?> font-semibold mb-2"><?php echo e($method['value']); ?></div>
          <p class="text-sm text-gray-400 mb-4"><?php echo e($method['desc']); ?></p>

          <div class="flex items-center gap-2 text-sm font-medium text-white <?php echo e($method['hoverText']); ?> transition-colors">
            <?php echo e($method['action']); ?>
  ...
  <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="grid lg:grid-cols-2 gap-12 items-start">
        ...
        <div class="space-y-3" x-data="{ open: null }">
          ...
          <div class="glass-panel rounded-xl border border-white/10 overflow-hidden">
            <button @click="open === <?php echo e($index); ?> ? open = null : open = <?php echo e($index); ?>"
              ...
              <span class="font-medium text-white text-sm"><?php echo e($faq['q']); ?></span>
              <i class="bi bi-chevron-down transition-transform" :class="open === <?php echo e($index); ?> ? 'rotate-180' : ''"></i>
            </button>
            <div x-show="open === <?php echo e($index); ?>"
              ...
              class="px-5 pb-4">
              <p class="text-sm text-gray-400 leading-relaxed"><?php echo e($faq['a']); ?></p>
            </div>
          </div>
          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
      ...
      <div class="glass-panel rounded-3xl border border-white/10 p-6 md:p-10 relative overflow-hidden">
        ...
        <form id="quoteForm" action="<?php echo e(route('quote.store')); ?>" method="POST" class="space-y-6">
          <?php echo csrf_field(); ?>
          ...
          <div class="space-y-4">
            ...
            <div class="space-y-2">
              ...
              <div class="flex flex-wrap gap-3">
                <?php $__currentLoopData = ['4K Gaming', 'Esports', 'Video Editing', '3D Rendering', 'Streaming', 'Programming', 'Office Work', 'VR Ready']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tag): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <label class="cursor-pointer inline-flex">
                  <input type="checkbox" name="use_case[]" value="<?php echo e($tag); ?>" class="sr-only peer">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\DigitronComputers\digitron-store\resources\views/pages/quote.blade.php ENDPATH**/ ?>